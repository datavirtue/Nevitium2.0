...
public class NoteDialog extends javax.swing.JDialog {
    ...
    public NoteDialog(java.awt.Frame parent, boolean modal, GlobalApplicationDaemon application, boolean select) {
        ...
        //jTable1.setModel(dbe.createTableModel(dbname, jTable1));
        //tm = jTable1.getModel();
        refreshTable();
    ...
    private void setView () {
        ...
        if (notesTable.getColumnCount() < 1) return;
    ...
    private void initComponents() {
        ...
        noteTextArea.setFont(new java.awt.Font("Courier", 0, 14));
        noteTextArea.setLineWrap(true);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        if (nameTextField.getText().equals("") && noteTextArea.getText().equals("")) return;
        
        if (!nameTextField.getText().equals(""));
        else {JOptionPane.showMessageDialog(this, "Please enter a name for the message.", "No Name?",  JOptionPane.OK_OPTION); return;}
        
        if (!noteTextArea.getText().equals(""));
        else {JOptionPane.showMessageDialog(this, "Please enter a message.", "No Message?",  JOptionPane.OK_OPTION); return;}
