...
public class InvoiceManager extends javax.swing.JDialog {
    ...
    private void setPayments () {
     ...
     int invKey = (Integer) tm.getValueAt(jTable1.getSelectedRow(),0);
        ...
        Invoice inv = new Invoice(application,invKey);
    ...
    private void returnButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_returnButtonActionPerformed
        ...
        if (jTable1.getSelectedRow() > -1){
            ...
            Invoice invoice = new Invoice(application, (Integer) tm.getValueAt(the_row, 0));
    ...
    private void closeInvoice(int row) {
        ...
        if (iValue != null && iValue.trim().equalsIgnoreCase("close")){
            ...
            invoice = new Invoice (application, invoice_key);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        if (!accessKey.checkInvoice(300)){
            ...
            InvoiceDialog id = new InvoiceDialog(parentWin, true, 0, application); //no select
            id.setVisible(true);
            id.dispose(); id = null;
