...
public class MyInventoryApp extends javax.swing.JDialog {
   ...
   private void recordScreenPosition(){
    ...
    private void populateFields () {
        ...
        dataOut [0] = (Integer) tm.getValueAt(iTable.getSelectedRow(), 0) ; 
        int refKey = (Integer)dataOut[0];
        
        getNote(refKey);

        upcTextField.setText((String) tm.getValueAt(iTable.getSelectedRow(), 1));
        nameTextField.setText((String) tm.getValueAt(iTable.getSelectedRow(), 2));
        descTextField.setText((String) tm.getValueAt(iTable.getSelectedRow(), 3));
        sizeTextField.setText((String) tm.getValueAt(iTable.getSelectedRow(), 4));
        weightTextField.setText((String) tm.getValueAt(iTable.getSelectedRow(), 5));
        
        //Version 1.5 Change to float
        
        qtyTextField.setText( Float.toString((Float) tm.getValueAt(iTable.getSelectedRow(), 6)));

        if (accessKey.checkInventory(300)){
            costTextField.setText(DV.money((Float) tm.getValueAt(iTable.getSelectedRow(), 7)));
        }
        priceTextField.setText(DV.money((Float) tm.getValueAt(iTable.getSelectedRow(), 8)));

        String category = (String) tm.getValueAt(iTable.getSelectedRow(), 9);
        ...
        lastSaleDate = (Long)tm.getValueAt(iTable.getSelectedRow(), 16);
        lastRecvDate = (Long)tm.getValueAt(iTable.getSelectedRow(), 17);
        ...
        jSpinner1.setValue((Integer) tm.getValueAt(iTable.getSelectedRow(), 18));
        ...
        for (int i = 0; i < supp.length; i++) {
            ...
            supp [i] = Integer.valueOf( (Integer) tm.getValueAt(iTable.getSelectedRow(),col ) );
        ...
        //check box
        taxCheckBox.setSelected((Boolean) tm.getValueAt(iTable.getSelectedRow(), 13));
        tax2CheckBox.setSelected((Boolean) tm.getValueAt(iTable.getSelectedRow(), 14));
        partialBox.setSelected((Boolean) tm.getValueAt(iTable.getSelectedRow(), 19));
        availableCheckBox.setSelected((Boolean) tm.getValueAt(iTable.getSelectedRow(), 15));
