...
import businessmanager.Reports.PDFLabels;
...
public class InventoryLabelsDialog extends javax.swing.JDialog {
    ...
    private void generateLabels() {
        ...
        if (def != null){  //begin action block
            ...
            PDFLabels pdf = new PDFLabels (def, filename);          
    ...
    private void initComponents() {
        ...
        labelPanel1 = new businessmanager.Common.LabelPanel();
    ...
    private businessmanager.Common.LabelPanel labelPanel1;
